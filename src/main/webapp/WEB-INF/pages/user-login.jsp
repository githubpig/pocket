...
<title></title>
<script src="statics/dmx/js/jquery-1.11.3.js" tppabs="http://jsg1.5.hengjihr.com/statics/dmx/js/jquery-1.11.3.js"></script>
<script src="statics/js/jquery.min.js" tppabs="http://jsg1.5.hengjihr.com/statics/js/jquery.min.js"></script>
<script src="statics/dmx/js/jquery.circliful.min.js" tppabs="http://jsg1.5.hengjihr.com/statics/dmx/js/jquery.circliful.min.js"></script>
<link rel="stylesheet" type="text/css" href="css/style.css" tppabs="http://jsg1.5.hengjihr.com/css/style.css">
<link rel="icon" href="/favicon.ico" type="image/x-icon" id="page_favionc">
<script src="statics/dmx/layer.js" tppabs="http://jsg1.5.hengjihr.com/statics/dmx/layer.js"></script>
...
<script type="text/javascript" src="statics/js/login.js" tppabs="http://jsg1.5.hengjihr.com/statics/js/login.js" charset="UTF-8"></script>
<!--con-->
	...
	<div class="w1200 bxb-log-con relative">
		...
		<div class="bxb-log-form absolute z50">
			...
			<div class="form-tit bxb-log-con">
				...
				<h6>
					<span class="fr">还未注册？<a href="user-register.htm" tppabs="http://jsg1.5.hengjihr.com/user-register">马上注册</a></span>
					登录</br>
			...
			<div class="form-box bxb-log-con">
				<ul>
					<li class="textAlign">
						...
						<input type="text"  id="username" name="username"  autocomplete="off" value=""  placeholder="用户名/手机号"  class="bxb-input" maxlength="15">
					</li>
 ...
 <label style="display:inline; float:left;" class="basic_label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
              <input type="checkbox" name="cookietime" value="2592000" id="cookietime"> 记住用户名</label>
					...
					<li class="leftMargin">
						...
						<input id="loginBt" name="登录" value="登 录" onclick="loginSubmit(this);" type="button" class="bxb-log-submit bxb-tran">
						<div class="agreement">
							...
							<p class="forget bxb-text-center">
								忘记密码?点击<a href="user-forgetpassword.htm" tppabs="http://jsg1.5.hengjihr.com/user-forgetpassword" class="bxb-focus">找回密码</a>
							</p>
						</div>
					</li>
				</ul>
			...
			<div class="bxb-log-ewm clearfix mt50">
				<div class="app-ban-link fl bxb-text-center">
					<a  class="bxb-tran android">
						<img src="css/btn_anr.png" tppabs="http://jsg1.5.hengjihr.com/css/btn_anr.png">
						Android版下载
					</a>

					<a  class="mt30 bxb-tran iphone">
						<img src="css/btn_ios.png" tppabs="http://jsg1.5.hengjihr.com/css/btn_ios.png">
						iPhone版下载
					</a>
				</div>

				<div class="app-ban-img fl">
					<img src="css/ewm.png" tppabs="http://jsg1.5.hengjihr.com/css/ewm.png">
				</div>
			</div>
		...
		<div class="bxb-log-element absolute z10">
			<img src="css/bxb-log-pic.png" tppabs="http://jsg1.5.hengjihr.com/css/bxb-log-pic.png">
		</div>
				...
				<div class="txt relative z10" >
					...
					<div class="pic clearfix" >
						<div class="pic_left pic_con" >
							<img src="css/ewm.png" tppabs="http://jsg1.5.hengjihr.com/css/ewm.png"  alt="APP下载">
						</div>
...
<a href="list-22-1.html" tppabs="http://jsg1.5.hengjihr.com/list-22-1.html" >网站公告</a>
			...
			<div class="fl ewm clearfix">
				<div class="app_ewm fl relative clearfix">
					...
					<div class="pic fl">
						<img src="css/ewm.png" tppabs="http://jsg1.5.hengjihr.com/css/ewm.png" alt="客户端下载">
					</div><br>苹果APP下载
				...
				<div class="app_ewm fr relative clearfix">
					...
					<div class="pic fl">
						<img src="css/ewm.png" tppabs="http://jsg1.5.hengjihr.com/css/ewm.png" >
						<img src="css/ewm.png" tppabs="http://jsg1.5.hengjihr.com/css/ewm.png" class="hidden">
...
<p><span style="color:#ff0000;"><span style="font-size:16px;"><!--地址：--><span style="font-family: 微软雅黑;">工作时间：09:00-23:00</span></span></span></p>
		...
		<div class="footer_db  clearfix " ><br>
			...
			<p><img alt="" src="uploadfile/2020/0225/20200225094041975.png" tppabs="http://jsg1.5.hengjihr.com/uploadfile/2020/0225/20200225094041975.png" style="width: 124px; height: 47px;" /><img alt="" src="uploadfile/2020/0225/20200225094101696.png" tppabs="http://jsg1.5.hengjihr.com/uploadfile/2020/0225/20200225094101696.png" style="width: 124px; height: 43px;" /><img alt="" src="uploadfile/2020/0225/20200225094139661.png" tppabs="http://jsg1.5.hengjihr.com/uploadfile/2020/0225/20200225094139661.png" style="width: 114px; height: 41px;" /><img alt="" src="uploadfile/2020/0225/20200225094208287.png" tppabs="http://jsg1.5.hengjihr.com/uploadfile/2020/0225/20200225094208287.png" style="width: 124px; height: 47px;" /><img alt="" src="uploadfile/2020/0225/20200225094707408.png" tppabs="http://jsg1.5.hengjihr.com/uploadfile/2020/0225/20200225094707408.png" style="width: 124px; height: 47px;" /><img alt="" src="uploadfile/2020/0225/20200225094356268.png" tppabs="http://jsg1.5.hengjihr.com/uploadfile/2020/0225/20200225094356268.png" style="width: 124px; height: 47px;" /><script type="text/javascript" src="../js.users.51.la/20657809.js" tppabs="http://js.users.51.la/20657809.js"></script> </p>
			...
			$.ajax({
				...
				success : function(data){
					...
					if(dataObj.code == -1){
						...
						//$("#phone").select();
						layer.msg("用户名或密码错误！！！");
						$(obj).text("登陆").attr("onclick","loginSubmit(this)");
