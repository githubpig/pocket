...
<title>长期专区 - 敏博投资-专业的互联网金融平台</title>
...
<link rel="stylesheet" type="text/css" href="css/style-2.0.css" tppabs="http://jsg1.5.hengjihr.com/css/style-2.0.css">
	...
	<div class="clist_nav w1200">
		<ul>
			...
			<li>
				...
				<a href="${basePath}/list" >全部</a>
				<a href="${basePath}/list191">新手专区</a> 
				<a href="${basePath}/list531">稳健项目</a>
				<a href="${basePath}/list541" class="on">长期专区</a>
				</li>
...
<div class="bxb-list-box bxb-bg-white bxb-m10-top bxb-p10-top bxb-p30-bottom">
		<div id="projectList" data-itemcount="${count}" data-model="content541"></div>
