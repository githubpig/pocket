...
<ul class="bxb-margin-center" id="projectList">
			<c:forEach items="${ps}" var="p" varStatus="cindex">
				 <li>
					<h5 class="tit">
						<a href="index.php-m=content&c=index&a=show&catid=53&id=24.htm" tppabs="http://jsg1.5.hengjihr.com/index.php?m=content&c=index&a=show&catid=53&id=24" >
						<span class="type">100%本息保障</span>
						<span class="text">${p.name }</span>
						</a>
						<a href="index.php-m=content&c=index&a=show&catid=53&id=24.htm" tppabs="http://jsg1.5.hengjihr.com/index.php?m=content&c=index&a=show&catid=53&id=24" >
							<span class="bxb-color-icon bxb-color-red">${p.repaymethod }</span>
						</a>
					</h5>
					...
					<div class="list bxb-clearfix bxb-m20-top">
						...
						<div class="remaining module bxb-fl">
						 ...
						 <div class="investment-btn bxb-fr bxb-text-center status_3">
							<a href="index.php-m=content&c=index&a=show&catid=53&id=24.htm" tppabs="http://jsg1.5.hengjihr.com/index.php?m=content&c=index&a=show&catid=53&id=24" class="bxb-tran">已投满</a>
						</div>
