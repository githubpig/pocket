...
<body>
	...
	<div class="user-top">
	    ...
	    <div class="nav">
	    	<a href="javascript:void(0);" class="l"><i class="icon-0101"></i><span>我的项目</span></a>
	        <a href="${basePath}/userinfo" class="l"><i class="icon-0423"></i><span>账户设置</span></a>
...
<c:forEach items="${ups}" var="up" varStatus="cindex">
 <div class="zsdata">
	<h1>${up.name}</h1>
    <div class="text"><span>投资金额</span><em style="color:#666">￥${up.money}</em></div>
    <div class="text"><span>日盈利率</span><em>${up.rate}</em></div>
    <div class="text"><span>已收益额度</span><em>${up.duo}</em></div>
    <a href="javasript:void(0)" class="but">增投申请</a>
    <a href="javasript:void(0)" class="but">体现申请</a>
</div>
</c:forEach>
<!-- <div class="zsdata">
	<h1>百赚利滚利版(嘉实活期宝)</h1>
